...
.cart-count {
  ...
  <body>
    ...
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="images/Book 10.jpg" alt="Begin Again" width="68%" />
        </div>
        <div class="col-2">
          <p>Home / Ebook</p>
          <h1>Begin Again by Eddie S. Glaude Jr.</h1>
          <h4>Rs.525</h4>
          <div class="rating">
          ...
          <a href="#" class="btn add-to-cart" data-id="7" data-title="Begin Again" data-price="525" data-image="images/Book 10.jpg" style="padding: 10px 20px; background: #ff523b; color: #fff; border: none; border-radius: 30px; font-size: 14px; cursor: pointer; transition: background 0.3s, transform 0.3s; text-decoration: none;">Add To Cart</a>
