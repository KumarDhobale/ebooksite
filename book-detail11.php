...
<html lang="en">
  ...
  <body>
    ...
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="images/Book 14.jpg" alt="Just Us" width="68%" />
        </div>
        <div class="col-2">
          <p>Home / Ebook</p>
          <h1>Just Us by Claudia Rankine</h1>
          <h4>Rs.570</h4>
          <div class="rating">
          ...
          <a href="#" class="btn add-to-cart" data-id="11" data-title="Just Us" data-price="570" data-image="images/Book 14.jpg" style="padding: 10px 20px; background: #ff523b; color: #fff; border: none; border-radius: 30px; font-size: 14px; cursor: pointer; transition: background 0.3s, transform 0.3s; text-decoration: none;">Add To Cart</a>
          <a href="payment.html" class="button">Purchase</a>
          <h3>Book Details <i class="fa fa-indent"></i></h3>
          <br />
          <p>
            Just Us: An American Conversation is a 2020 book and anthology of essays, poems, and personal anecdotes written by American author and poet Claudia Rankine. An “arrangement of essays, poems, and images [which] includes the voices and rebuttals of others,” it describes and outlines an ideal response to forms of racism in contemporary settings. The book received largely critical praise and positive reviews from critics, who described it as “lyrically exquisite” and a “visual and active inquiry into race.”
          </p>
        </div>
      </div>
    </div>
