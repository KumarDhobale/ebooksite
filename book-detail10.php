...
.cart-count {
  ...
  <body>
    ...
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="images/Book 13.jpg" alt="Want" width="68%" />
        </div>
        <div class="col-2">
          <p>Home / Ebook</p>
          <h1>Want by Cindy Pon</h1>
          <h4>Rs.560</h4>
          <div class="rating">
          ...
          <a href="#" class="btn add-to-cart" data-id="10" data-title="Want" data-price="560" data-image="images/Book 13.jpg" style="padding: 10px 20px; background: #ff523b; color: #fff; border: none; border-radius: 30px; font-size: 14px; cursor: pointer; transition: background 0.3s, transform 0.3s; text-decoration: none;">Add To Cart</a>
          <a href="payment.html" class="button">Purchase</a>
          <h3>Book Details <i class="fa fa-indent"></i></h3>
          <br />
          <p>
            Want is a 2017 young adult science fiction novel by Cindy Pon, set in a near-future Taipei. The story follows Zhou, a young man who joins a group of rebels to take down the corrupt elite who control the city's wealth and technology. Living in a divided society where the rich wear protective suits against pollution and the poor suffer, Zhou and his allies risk everything to infiltrate the elite and expose their secrets. The novel explores themes of inequality, environmental degradation, and resistance, blending high-stakes action with a vivid depiction of a futuristic Taiwan.
          </p>
        </div>
      </div>
    </div>
