...
.cart-count {
  ...
  <body>
    ...
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="images/Book 5.jpg" alt="Watership Down" width="68%" />
        </div>
        <div class="col-2">
          <p>Home / Ebook</p>
          <h1>Watership Down by Richard Adams</h1>
          <h4>Rs.399</h4>
          <div class="rating">
          ...
          <a href="#" class="btn add-to-cart" data-id="2" data-title="Watership Down" data-price="399" data-image="images/Book 5.jpg" style="padding: 10px 20px; background: #ff523b; color: #fff; border: none; border-radius: 30px; font-size: 14px; cursor: pointer; transition: background 0.3s, transform 0.3s; text-decoration: none;">Add To Cart</a>
