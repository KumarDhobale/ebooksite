...
.cart-count {
  ...
  <body>
    ...
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="images/Book 16.jpg" alt="Anna Karenina" width="68%" />
        </div>
        <div class="col-2">
          <p>Home / Ebook</p>
          ...
          <a class="btn add-to-cart" data-id="1" data-title="Anna Karenina" data-price="499" data-image="images/Book 16.jpg" style="padding: 10px 20px; background: #ff523b; color: #fff; border: none; border-radius: 30px; font-size: 14px; cursor: pointer; transition: background 0.3s, transform 0.3s; text-decoration: none;">Add To Cart</a>
