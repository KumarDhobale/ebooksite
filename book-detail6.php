...
.cart-count {
  ...
  <body>
    ...
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <img src="images/Book 9.jpg" alt="The Sword and the Shield" width="68%" />
        </div>
        <div class="col-2">
          <p>Home / Ebook</p>
          <h1>The Sword and the Shield by Vadim Kozhevnikov</h1>
          <h4>Rs.600</h4>
          <div class="rating">
          ...
          <a href="#" class="btn add-to-cart" data-id="6" data-title="The Sword and the Shield" data-price="600" data-image="images/Book 9.jpg" style="padding: 10px 20px; background: #ff523b; color: #fff; border: none; border-radius: 30px; font-size: 14px; cursor: pointer; transition: background 0.3s, transform 0.3s; text-decoration: none;">Add To Cart</a>
          ...
          <p>
            ...
            The year is 1940 and Nazi Germany is at the height of its military power, having captured most of Europe and eyeing the Soviet Union to the East. The Soviet military command suspects hostile intent from Germany and so arranges for its spies to infiltrate ranks of the German military and the SS.
          </p>
        </div>
      </div>
    </div>
